...
<body>
    ...
    <?php
        ...
        <div class="container">
            ...
            <a href="index.php"><img src="Img/logo.png" width="400px" height="90px"></a>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="5000">
                    ...
                    <center>
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item">
                                <img src="Img/fashion.jpg" alt="News3">
                                <div class="carousel-caption">
                ...
                <form method="post">
                    <div class="col-md-6 col-xs-12 signInTab">
                        <center>
                            ...
                            <br><br>
                            <p style="font-size:16px;">New to Tweets? Sign Up Here.. <span class="glyphicon glyphicon-arrow-right"></span></p>
                        </center>
                    </div>
                </form>
            ...
            <div class="container-fluid aboutDiv" id="about">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-10" style="padding-left:30px;">
                        ...
                        <p class="aboutInfo"><span class="glyphicon glyphicon-envelope"></span> <b>Mail Us:</b><br> <a href="mailto:Vyapakmishra25@gmail.com">Vyapakmishra25@gmail.com</a></p>

                        <p class="aboutInfo"><span class="glyphicon glyphicon-phone"></span> <b>Contact Us:</b><br> 06388394238</p>

                        <p class="aboutInfo"><i class="fa fa-facebook-square"></i> <b>Follow Us:</b><br> <a href="http://Facebook.com/VyapakMishra">Facebook.com/VertoTweets</a></p>
                        <br>
                        <p>Vertos Twitter Social Platform</p>
