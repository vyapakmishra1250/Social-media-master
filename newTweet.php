        ...
        <div class="row">
            <div class="col-md-6 col-md-push-3 cusContainer" style="padding:0px;">
                <div style="background-color:white;">
                    <a href="homepage.php"><img src="Img/logo.png " width="300px " height="80px " alt="FutatweetsLogo" style="margin:10px 0px 10px 20px"></a>
                ...
                <div id="recentTw" class="mainContainer" style="height:auto;">
                    ...
                    <?php
                        ...
                        ?>
                        <form method="post">
                            <textarea placeholder="What's Happening in LPU?" name="txtNewTweet" rows="5" cols="90" required style="font-size:16px;padding:10px; width:90%"></textarea><br><br>
